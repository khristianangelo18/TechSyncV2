// frontend/src/pages/ProjectSidebar.js - WITH TOGGLE SUPPORT
...
function ProjectSidebar() {
  ...
  useEffect(() => {
    const handleSidebarToggle = (event) => {
      ...
      localStorage.setItem('projectSidebarCollapsed', newState.toString());
    };
    ...
    return (
      <div style={styles.sidebar}>
        ...
        <div style={styles.header}>
          <div style={styles.loading}>Loading project name...</div>
        </div>
      </div>
    );
  }
